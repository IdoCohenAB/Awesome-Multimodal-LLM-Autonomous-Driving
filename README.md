...
|-----------------------------------------------------------------------------|------|-------------------------|-----------------------------------|--------------------------|---------------------|----------------------|--------------------|
| [Driving with LLMs](https://arxiv.org/abs/2310.01957)                       | 2023 | LLaMA                   | Perception Control                | Vision, Language          | Finetune            | Vector Query         | Response / Actions |
...
| [Language Agent](https://arxiv.org/abs/2311.10813)                          | 2023 | GPT-3.5                 | Planning                          | Language                 | Training            | Text                 | Action             | NuScene Object list input - used functions to get relevant objects/map/future path prediction - not images/videos. missing code, but bread-down concept is good
| [LMDrive](https://arxiv.org/abs/2312.07488)                                 | 2023 | CARLA + LLaVA           | Planning Control                  | Vision, Language          | Finetune            | RGB Image LiDAR Text | Control Signal     | Closed-Loop End-to-End Driving with Large Language Models
...
| [DriveMLM](https://arxiv.org/abs/2312.09245)                                | 2023 | LLaMA+Q-Former          | Perception Planning               | Vision, Language          | Training            | RGB Image LiDAR Text | Decision State     | We employ a multi-modal LLM (MLLM) to model the behavior planning module of a module AD system, which uses driving rules, user commands, and inputs from various sensors (\eg, camera, lidar) as input and makes driving decisions and provide explanations. Missing code
| [DriveLM](https://arxiv.org/abs/2312.14150)                                 | 2023 | GVQA                    | Perception Planning               | Vision, Language          | Training            | RGB Image Text       | Text / Action      |   
| [LangProp](https://arxiv.org/abs/2401.10314)                                | 2024 | IL, DAgger, RL + ChatGPT  | Planning (Code/Action Generation) | CARLA simulator Vsion, Language | Training            | CARLA simulator Text | Code as action     | use supervised and RL to train GPT in general, and for driving in carla
| [LimSim++](https://arxiv.org/abs/2402.01246)                                | 2024 | LimSim, GPT-4  |  Planning  |  Simulator BEV, Language  |  In-context learning   |   Simulator Vision, Language   |   Text / Action     | LimSim++ a versatile tool for research and practice - for long-term closed-loop infrastructure supporting continuous learning and improved generalization in autonomous driving. BEV only, including junction negotation
...
| [RAG-Driver](https://arxiv.org/abs/2402.10828)                                | 2024 | Vicuna1.5-7B  |   Planning Control   |   Video, Language   |   Training   |   Vision, Language   |   Text / Action     | uses video retrieval for prediction, and performs MLLM. missing code
